...
// @from(Start 1531738, End 1535761)
Z_A = z((Ce5, G_A) => {
  function sl9(A) {
    if (!A) return null;
  ...
  function ol9(A) {
    let B = {
      ...
      Z = {
        ...
        keywords: B,
        contains: [G, A.C_LINE_COMMENT_MODE, A.C_BLOCK_COMMENT_MODE, A.QUOTE_STRING_MODE, A.APOS_STRING_MODE, A.C_NUMBER_MODE]
      },
      D = /[a-z0-9&#*=?@\\><:,()$[\]_.{}!+%^-]+/,
      Y = {
    ...
    return {
      ...
      contains: [A.COMMENT(/^\$ontext/, /^\$offtext/), {
        ...
        contains: [A.COMMENT("^\\*", "$"), A.C_LINE_COMMENT_MODE, A.C_BLOCK_COMMENT_MODE, A.QUOTE_STRING_MODE, A.APOS_STRING_MODE, Z, Y]
      }, {
        beginKeywords: "table",
        end: ";",
        returnBegin: !0,
...
// @from(Start 1535767, End 1550044)
Y_A = z((Ke5, D_A) => {
  function tl9(A) {
    let B = {
      ...
      Z = [{
        ...
        contains: [{
          className: "literal",
          begin: /\.\.\./
        }, A.C_NUMBER_MODE, A.C_BLOCK_COMMENT_MODE, Q, G]
      }],
      D = {
        className: "title",
        begin: A.UNDERSCORE_IDENT_RE,
      ...
      Y = function(V, C, K) {
        ...
        return E.contains.push(D), E.contains.push(A.C_NUMBER_MODE), E.contains.push(A.C_BLOCK_COMMENT_MODE), E.contains.push(Q), E
      },
      W = {
        className: "built_in",
        begin: "\\b(" + B.built_in.split(" ").join("|") + ")\\b"
      },
      J = {
        className: "string",
        begin: '"',
      ...
      X = {
        ...
        contains: [A.C_NUMBER_MODE, A.C_BLOCK_COMMENT_MODE, Q, W, F, J, "self"]
      };
    return F.contains.push(X), {
      name: "GAUSS",
      aliases: ["gss"],
      case_insensitive: !0,
      keywords: B,
      illegal: /(\{[%#]|[%#]\}| <- )/,
      contains: [A.C_NUMBER_MODE, A.C_LINE_COMMENT_MODE, A.C_BLOCK_COMMENT_MODE, Q, J, I, {
        className: "keyword",
        ...
        relevance: 0,
        contains: [A.C_BLOCK_COMMENT_MODE, Q, X]
      }, {
        variants: [{
...
// @from(Start 1550050, End 1551536)
J_A = z((He5, W_A) => {
  function el9(A) {
    let I = {
      ...
      D = [A.C_LINE_COMMENT_MODE, A.C_BLOCK_COMMENT_MODE, A.COMMENT(/\(/, /\)/), Z, A.inherit(A.APOS_STRING_MODE, {
        illegal: null
...
// @from(Start 1551542, End 1552342)
X_A = z((ze5, F_A) => {
  function Ai9(A) {
    return {
      name: "Gherkin",
...
// @from(Start 1552348, End 1560808)
C_A = z((we5, V_A) => {
  function Bi9(A) {
    return {
      name: "GLSL",
...
// @from(Start 1560814, End 1611470)
H_A = z((Ee5, K_A) => {
  function Qi9(A) {
    return {
      name: "GML",
...
// @from(Start 1611476, End 1612809)
w_A = z((Ue5, z_A) => {
  function Ii9(A) {
    let B = {
...
// @from(Start 1612815, End 1613460)
U_A = z((Ne5, E_A) => {
  function Gi9(A) {
    return {
      name: "Golo",
...
// @from(Start 1613466, End 1615082)
$_A = z(($e5, N_A) => {
  function Zi9(A) {
    return {
      name: "Gradle",
...
// @from(Start 1615088, End 1617488)
M_A = z((qe5, q_A) => {
  function Di9(A) {
    if (!A) return null;
    if (typeof A === "string") return A;
  ...
  function Ji9(A) {
    let Q = hT1([A.C_LINE_COMMENT_MODE, A.C_BLOCK_COMMENT_MODE, A.COMMENT("/\\*\\*", "\\*/", {
        relevance: 0,
        contains: [{
          begin: /\w+@/,
          relevance: 0
      ...
      G = hT1([A.BINARY_NUMBER_MODE, A.C_NUMBER_MODE]),
      Z = hT1([{
        begin: /"""/,
        end: /"""/
      }, {
    ...
    return {
      ...
      contains: [A.SHEBANG({
        ...
        relevance: 0,
        contains: [Q, Z, I, G, "self"]
      }, {
        className: "symbol",
        begin: "^[ 	]*" + Yi9("[A-Za-z0-9_$]+:"),
        excludeBegin: !0,
        end: "[A-Za-z0-9_$]+:",
        relevance: 0
      }],
...
// @from(Start 1617494, End 1619382)
R_A = z((Me5, L_A) => {
  function Fi9(A) {
    return {
      name: "HAML",
...
// @from(Start 1619388, End 1623247)
P_A = z((Le5, T_A) => {
  function O_A(A) {
    if (!A) return null;
    if (typeof A === "string") return A;
...
// @from(Start 1623253, End 1625786)
__A = z((Re5, S_A) => {
  function Hi9(A) {
    let B = {
    ...
    return {
      ...
      }, Q, I, A.QUOTE_STRING_MODE, A.C_NUMBER_MODE, G, A.inherit(A.TITLE_MODE, {
        begin: "^[_a-z][\\w']*"
      }), B, {
        begin: "->|<-"
      }]
...
// @from(Start 1625792, End 1628786)
y_A = z((Oe5, j_A) => {
  function zi9(A) {
    return {
      name: "Haxe",
